...
do j=1, n_ord
		...
		chi2 = chi2 + (free_g(j)-gammaf)**2

		if (rectifinal) then
			write (670,*) j, free_g(j),gammaf
		end if	
	end if
end do ! j=n_ord
...
end function prefit_g_func

end module prefit_g_func_module
