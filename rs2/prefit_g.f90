...
do part2=1, 1
	...
	do l=1,n_conv
		...
		! let's roll
		call amoeba(p,z,ftol_pres,prefit_g_func,iter,200000)

		! determine the best result
		posmin = minloc(z,1)
		x = p(posmin,:)
		chi2 = z(posmin)
		print *, "prefit_g, current part2, convergence, chi2: ", part2,l,chi2
		print *, "x = ", x
	...
	if (rectify) then
	        rectifinal = .true.
	        chi2 = prefit_g_func(x)
	        rectifinal = .false.
	end if
end do

end subroutine prefit_g

end module prefit_g_module
