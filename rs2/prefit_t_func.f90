...
do j=1, n_ord
		...
		chi2 = chi2 + (free_t(j)-thetaf)**2

		if (rectifinal) then
			write (669,*) j, free_t(j), thetaf
		end if	
	end if
end do ! j=n_ord
...
end function prefit_t_func

end module prefit_t_func_module
