...
do j=1, n_ord
		...
		deltaf = 0.d0
                ...
                chi2 = chi2 + (free_d(j)-deltaf)**2

		if (rectifinal) then
			write (667,*) j, free_d(j),  deltaf
		end if	
	end if
end do ! j=n_ord
...
end function prefit_d_func

end module prefit_d_func_module
